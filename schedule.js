(() => {
  ...
  const additionalEvents = {
    ...
    "2026-07-10": [{ title: "⚽ 전설의 교관", items: ["괴수/야수"] }],
    "2026-07-11": [
      { title: "⚽ 전설의 교관", items: ["영웅모집", "파편", "가속"] },
    ],
    "2026-07-12": [{ title: "⚽ 전설의 교관", items: ["훈련"] }],
    "2026-07-13": [
      { title: "⚽ 전설의 교관", items: ["망치", "부속품", "다이아"] },
    ],
    ...
    "2026-08-04": [
      { title: "✨ 쌍둥이별", items: ["전투력증가", "영웅모집", "파편"] },
    ],
    "2026-08-05": [{ title: "✨ 쌍둥이별", items: ["괴수/야수"] }],
    "2026-08-06": [
      { title: "✨ 쌍둥이별", items: ["영웅모집", "파편", "가속"] },
    ],
    "2026-08-07": [{ title: "✨ 쌍둥이별", items: ["훈련"] }],
    "2026-08-08": [
      { title: "✨ 쌍둥이별", items: ["망치", "부속품", "다이아"] },
    ],
    "2026-08-09": [{ title: "✨ 쌍둥이별", items: ["채집", "전투력증가"] }],
    "2026-08-10": [{ title: "✨ 쌍둥이별", items: ["장비", "가속"] }],
  };
